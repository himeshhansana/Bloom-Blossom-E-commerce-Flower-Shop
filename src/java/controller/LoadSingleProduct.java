        ...
        if (Util.isInteger(productId)) {
            ...
            try {
                ...
                if (product.getStatus().getValue().equals("Active")) {
                    ...
                    Criteria c1 = s.createCriteria(Flower_type.class);
                    c1.add(Restrictions.eq("flowers_category", product.getFlower_type().getFlowers_category()));
                    List<Flower_type> Flower_typeList = c1.list();

                    Criteria c2 = s.createCriteria(Product.class);
                    c2.add(Restrictions.in("flower_type", Flower_typeList));
